    ...
    <div style={{ padding: '24px 28px', background: G.bg, minHeight: '100%' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: G.text }}>Clientes Financeiros</h1>
            <p style={{ margin: 0, fontSize: 12, color: G.muted }}>Clientes para contas a receber e lançamentos financeiros</p>
          </div>
        </div>
