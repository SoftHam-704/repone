...
const FIELD_LABELS: Record<TextareaKey, { label: string; required: boolean; fullWidth?: boolean; wide?: boolean; hint?: string }> = {
  ...
  peso:               { label: 'Quantidade',          required: false, hint: 'Fator de quantidade do produto. Combina com o "Preço por Quantidade": o preço passa a ser Preço × Quantidade.' },
  prepeso:            { label: 'Preço por Quantidade (R$)', required: false, hint: 'Quando informado, o preço passa a ser Preço × Quantidade, ignorando os preços de tabela.' },
