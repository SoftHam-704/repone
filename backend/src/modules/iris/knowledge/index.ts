...
const FILES = [
  ...
  'oficio-00-postura.md', 'oficio-01-ciclo-comercial.md', 'oficio-02-ler-a-carteira.md', 'oficio-03-jogo-das-industrias.md', 'oficio-04-negociacao.md', 'oficio-05-qual-tool-usar.md', 'oficio-06-cadastrar-itens.md', 'oficio-07-cadastrar-clientes-industrias.md', 'oficio-08-manutencao-catalogo.md', 'oficio-09-inativar-sem-movimento.md', 'oficio-decisoes.md',
];
