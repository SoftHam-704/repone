...
import { getIrisCartaHandler, saveIrisCartaHandler, enhanceIrisCartaHandler } from './iris-config.controller';
...
authRouter.post('/iris-carta/enhance',         enhanceIrisCartaHandler);
